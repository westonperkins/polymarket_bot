...
SPOT_ACTIVE_WINDOW = 300           # seconds before close to start active polling (full candle)
...
FAK_ORDER_ENABLED = os.environ.get("FAK_ORDER_ENABLED", "true").lower() == "true"
...
LIMIT_MIN_SHARES = float(os.environ.get("LIMIT_MIN_SHARES", "5"))
LIMIT_FORCE_MIN_SHARES = os.environ.get("LIMIT_FORCE_MIN_SHARES", "false").lower() == "true"
